        ...
        {rows.map((row) => (
          ...
          >
            <div className="grid min-h-24 grid-cols-[minmax(0,1fr)_4.25rem_6.75rem] items-center gap-2 px-3 py-3 min-[430px]:grid-cols-[minmax(0,1fr)_4.75rem_7.75rem] min-[430px]:px-4 sm:grid-cols-[minmax(0,1fr)_8rem_10rem] sm:gap-4 sm:px-5">
              ...
              <div className="flex h-14 items-center justify-center gap-1.5 rounded-md border border-sky-100 bg-white/70 px-1.5 text-center min-[430px]:gap-2 min-[430px]:px-3 sm:h-16 dark:border-white/10 dark:bg-white/[0.04]">
                <ShoppingCart className="hidden h-4 w-4 text-sky-700 sm:block dark:text-cyan-200/75" />
                <div className="min-w-0">
              ...
              <div className="flex h-14 items-center justify-end rounded-md border border-sky-100 bg-white/70 px-2 text-right min-[430px]:gap-2 min-[430px]:px-3 sm:h-16 dark:border-white/10 dark:bg-white/[0.04]">
                <div className="hidden h-8 w-8 shrink-0 items-center justify-center rounded-full bg-sky-100 text-sky-700 dark:bg-cyan-300 dark:text-slate-950 sm:flex">

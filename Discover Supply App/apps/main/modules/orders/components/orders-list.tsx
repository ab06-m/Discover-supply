...
function DailySalesCard({
  ...
  return (
    <Card className="overflow-hidden border-cyan-900/40 bg-gradient-to-r from-slate-950 via-cyan-950/35 to-slate-950 shadow-card">
      <div className="grid min-h-24 grid-cols-[minmax(0,1fr)_4.25rem_6.75rem] items-center gap-2 px-3 py-3 min-[430px]:grid-cols-[minmax(0,1fr)_4.75rem_7.75rem] min-[430px]:px-4 sm:grid-cols-[minmax(0,1fr)_8rem_10rem] sm:gap-4 sm:px-5">
        ...
        <div className="flex h-14 items-center justify-center rounded-md border border-white/10 bg-white/[0.04] px-1.5 text-center min-[430px]:px-3 sm:h-16">
          <div className="min-w-0">
        ...
        <div className="flex h-14 items-center justify-end rounded-md border border-white/10 bg-white/[0.04] px-2 text-right min-[430px]:px-3 sm:h-16">
          <div className="min-w-0">
